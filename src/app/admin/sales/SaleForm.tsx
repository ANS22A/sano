    ...
    <div className="max-w-2xl space-y-6">
      ...
      <div className="flex items-center gap-3">
        <Link
          ...
          className="p-2 rounded-xl border border-[#e8e2d9] dark:border-[#382b42] bg-white dark:bg-[#1a141f] text-[#7a6b61] dark:text-[#c4b5a5] hover:text-foreground dark:hover:text-white hover:bg-[#f8f5f0] dark:hover:bg-primary transition-colors"
        >
          {isAr ? <ArrowRight className="w-4 h-4" /> : <ArrowLeft className="w-4 h-4" />}
        </Link>
        <div>
          <h1 className="text-xl font-bold text-foreground dark:text-[#f8f5f0]">
            {bookingNumber
              ? isAr
      ...
      >
        ...
        {bookingNumber && (
          <div className="p-4 rounded-xl bg-secondary/5 dark:bg-secondary/15 border border-secondary/20 text-sm space-y-1">
            <div className="flex justify-between items-center text-xs text-[#7a6b61] dark:text-[#c4b5a5]">
              ...
              <span className="font-semibold text-foreground dark:text-[#f8f5f0]">#{bookingNumber}</span>
            </div>
            {customerName && (
              <div className="flex justify-between items-center text-xs text-[#7a6b61] dark:text-[#c4b5a5]">
                <span>{isAr ? 'العميل:' : 'Customer:'}</span>
                <span className="font-medium text-foreground dark:text-[#f8f5f0]">{customerName}</span>
              </div>
            )}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
          <div>
            <label className="block text-xs font-semibold text-foreground dark:text-[#f8f5f0] mb-1.5">
            ...
            <div className="relative">
              <input
                ...
                placeholder="0.00"
                className="w-full text-sm rounded-xl border border-[#e8e2d9] dark:border-[#382b42] bg-[#f8f5f0] dark:bg-primary px-3.5 py-2.5 text-foreground dark:text-[#f8f5f0] focus:outline-none focus:ring-2 focus:ring-ring/20 focus:border-secondary"
              />
        ...
        <div>
          ...
          <div className="border border-dashed border-[#e8e2d9] dark:border-[#382b42] rounded-xl p-4 text-center hover:bg-[#f8f5f0]/50 dark:hover:bg-primary/30 transition-colors">
            <input
              type="file"
        ...
        <div className="flex items-center justify-end gap-3 pt-4 border-t border-[#e8e2d9] dark:border-[#382b42]">
          <Link
            href={bookingId ? `/admin/bookings/${bookingId}` : '/admin/sales'}
            className="px-4 py-2.5 rounded-xl border border-[#e8e2d9] dark:border-[#382b42] text-xs font-semibold text-[#7a6b61] dark:text-[#c4b5a5] hover:bg-[#f8f5f0] dark:hover:bg-primary transition-colors"
          >
            {isAr ? 'إلغاء' : 'Cancel'}
          </Link>
          <button
            type="submit"
            disabled={isPending}
            className="inline-flex items-center gap-2 px-5 py-2.5 rounded-xl bg-secondary text-white text-xs font-semibold hover:bg-[#5D3D6A] transition-colors shadow-sm disabled:opacity-50"
          >
