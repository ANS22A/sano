      ...
      <div className="flex flex-col sm:flex-row gap-3">
        ...
        <div className="flex flex-col sm:flex-row gap-2 w-full sm:w-auto">
          ...
          <div className="flex gap-2 flex-wrap">
            ...
            {(sp.q || sp.status || sp.date || sp.serviceId || sp.locationId) && (
              <Link
                href="/admin/bookings"
            ...
            <table className="w-full text-sm">
              <thead>
                <tr className="bg-[#faf7f4] border-b border-[#e8ddd0]">
                  {[t.bookings.bookingNumber, t.bookings.customer, t.bookings.service, t.bookings.date, t.bookings.status, t.bookings.price, t.bookings.actions].map((h) => (
